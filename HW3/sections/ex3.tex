...
Since the Gaussian family is an exponential family, so is the AR(1) model. Hence we conclude the model with parameter vector $\theta$ forms an exponential family and thus the homework is finished!